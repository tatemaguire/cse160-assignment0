...
class Vector3 {
    ...
    static cross(other1, other2) {
        let v1_data = other1.elements;
        let v2_data = other2.elements;

        let v3 = new Vector3([
            v1_data[1] * v2_data[2] - v1_data[2] * v2_data[1],
            -(v1_data[0] * v2_data[2] - v1_data[2] * v2_data[0]),
            v1_data[0] * v2_data[1] - v1_data[1] * v2_data[0],
        ]);

        // v3.elements[0] = v1_data[1] * v2_data[2] - v1_data[2] * v2_data[1];
        // v3.elements[1] = -(v1_data[0] * v2_data[2] - v1_data[2] * v2_data[0]);
        // v3.elements[2] = v1_data[0] * v2_data[1] - v1_data[1] * v2_data[0];
